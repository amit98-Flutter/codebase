...
import 'package:codebase/features/user_list/data/repositories/user_repository_impl.dart';
...
void setupUserLocator() async {
  ...
  //Register Repository
  slUser.registerLazySingleton<UserRepository>(() => UserRepositoryImpl(remoteDataSource: slUser<UserRemoteDataSource>()));

  //Register Use Case
  slUser.registerLazySingleton<GetUsers>(() => GetUsers(slUser<UserRepository>()));

  //Register Bloc
  slUser.registerFactory<UserBloc>(() => UserBloc(getUsers: slUser<GetUsers>()));
}
